...
//            console.log("Incorect Attribut: " + attrName + " = " + dynamoObj[attrName] + "\n\n" + JSON.stringify(dynamoObj)); // + " = " + this.attributes[attrName] instanceof Object? JSON.stringify(this.attributes[attrName]) : this.attributes[attrName] );
        }
    }
